Aquí tienes la lista de tareas organizada para que puedas gestionar las modificaciones de tu página web de manera estructurada y eficiente:

### 📋 Lista de Tareas: Modificaciones de la Página Web

#### 🎨 Diseño y Estructura (UI/UX)

* [ ] **Optimización de Home:**
* [ ] Centralizar el texto y el título para mejorar la visualización en PC (evitar que se vea muy arriba).
* [ ] Implementar un diseño de dos columnas en el *Home*: colocar una imagen al lateral y el título/texto hacia el otro lado con un ángulo visual atractivo.
* [ ] Aplicar la paleta de colores enviada previamente.
